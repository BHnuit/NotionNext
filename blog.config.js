...
const BLOG = {
  ...
  SINCE: process.env.NEXT_SINCE || 2010, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '一个自言自语的合订本',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Nuit', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '明月应似我', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bhnuit.cn', // 网站地址
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://movie.douban.com/people/144104707', // 你的linkedIn 首页，已替换为豆瓣电影
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://book.douban.com/people/144104707', // 您的instagram地址，已替换为豆瓣读书
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://www.xiaohongshu.com/user/profile/614c73e2000000000201eb92', // B站主页，已替换为小红书
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://open.spotify.com/user/31z7xqx65rve65fw5kr4yraqlafq', // Youtube主页，已替换为Spotify

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/moon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  PREVIEW_TAG_COUNT: 4, // 首页最多展示的标签数量，0为不限制
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Nuit Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '月亮背面的自留地', // 站点描述，被notion中的页面描述覆盖
