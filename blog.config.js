...
const BLOG = {
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://neodb.social/users/Nuit/complete/movie/', // 你的linkedIn 首页，已替换为NeoDB电影
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://neodb.social/users/Nuit/complete/movie/', // 您的instagram地址，已替换为NeoDB读书
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页，已替换为小红书
